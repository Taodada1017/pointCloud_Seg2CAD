...
public:
    ...
    // Set a fixed global origin for rasterization (optional).
    // If not set explicitly, origin_ is initialized from input points' min XY.
    void setOrigin(const Eigen::Vector2d& origin) { origin_ = origin; }
